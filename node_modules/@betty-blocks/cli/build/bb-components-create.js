...
/* process arguments */
commander_1.default.usage('[path]').name('bb components create').parse(process.argv);
...
void (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield Promise.all(LIST.map((fileName) => fs_extra_1.move(`${dest}/__${fileName}`, `${dest}/${fileName}`)));
